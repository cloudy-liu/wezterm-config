-- wezterm-config-theme: tabby-darcula-hack-pill
-- Tabby-JetBrains-Darcula with Hack and tmux/ccmux-style rounded pill tabs.
-- Fork of tabby-darcula; pill tab chrome comes from one-dark-pro-pill.
-- Install via: python install_theme.py install tabby-darcula-hack-pill
...
-- (the non-pill tabby-darcula row height).
...
-- Kitty keyboard protocol: kept off. It lets apps request enhanced key encoding
-- (e.g. Neovim distinguishing Ctrl+I from Tab), but WezTerm's implementation is
-- buggy, so we stay on the upstream default of false.
...
-- ============================================================================
-- Appearance: Tabby Darcula surface, plus ccmux-style pill tabs.
...
config.window_frame = {
    ...
    inactive_titlebar_bg = '#202A35',
    button_fg = '#808080',
    button_bg = '#202A35',
    button_hover_fg = '#ADADAD',
    button_hover_bg = '#131D27',
}
...
wezterm.on('format-window-title', function()
    ...
    return 'WezTerm · Tabby Darcula Hack Pill'
end)
...
local pill = {
    ...
    bar_bg = '#202A35',
    -- inactive tab: darker Darcula gutter capsule
    tab_bg = '#131D27',
    tab_fg = '#808080',
    -- active tab: accent-filled capsule (dark text on Darcula blue) so it reads at a glance;
    -- the inactive capsule stays quiet against the seamless base-colored bar.
    active_tab_bg = '#4581EB',
    active_tab_fg = '#202A35',
