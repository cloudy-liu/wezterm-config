-- Luna-Night: snapshot of the active global Western/Luna-inspired theme.
-- File renamed from western-luna.wezterm.lua for clearer repo naming.
...
-- Cursor: no theme color; thin bar (not a thick block)
